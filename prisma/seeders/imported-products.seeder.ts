...
export async function seedImportedProducts(prisma: PrismaClient) {
  ...
  const catalogDataset = [
    ...
    // ============================================================
    {
      ...
      description:
        'Premium 300gsm heavyweight cotton tee with distressed graphic print. Boxy oversized cut.',
      costPrice: 6.8,
      sellingPrice: 22.99,
    ...
    },
    {
      ...
      description:
        'Utilitarian cargo trousers in ripstop fabric. Wide-leg, adjustable drawstring hem.',
      costPrice: 14.5,
      sellingPrice: 45.99,
      shippingEstimate: 4.0,
    ...
    },
    {
      ...
      description:
        'Shiny satin bomber with ribbed cuffs, embroidered chest logo, and inner quilted lining.',
      costPrice: 22.0,
      sellingPrice: 69.99,
    ...
    },
    {
      ...
      description:
        'Compact waterproof crossbody bag with USB charging port, earphone hole, and adjustable strap.',
      costPrice: 8.9,
      sellingPrice: 29.99,
      ...
      rawData: {
        productNameEn: 'Crossbody Sling Bag',
        categoryName: 'Bags',
        weight: '0.25kg',
        score: 8.8,
        verdict: 'SELL',
    ...
    // ============================================================
    {
      ...
      description:
        'Professional grade foam cannon for pressure washers. Creates thick car shampoo foam blanket.',
      costPrice: 12.0,
      sellingPrice: 39.99,
      shippingEstimate: 3.5,
      ...
      rawData: {
        productNameEn: 'Foam Cannon Wash Kit',
    ...
    },
    {
      ...
      description:
        '170° wide angle front camera, loop recording, G-sensor shock detection, and built-in GPS logger.',
      costPrice: 28.5,
      sellingPrice: 79.99,
      shippingEstimate: 4.0,
      ...
      rawData: {
        productNameEn: '4K Dash Camera with GPS',
        categoryName: 'Car Electronics',
        weight: '0.3kg',
        score: 9.0,
        verdict: 'SELL',
    ...
    // ============================================================
    {
      ...
      description:
        'Educational coding robot kit with 200+ parts, LED eyes, Bluetooth app control, and solar power option.',
      costPrice: 18.5,
      sellingPrice: 54.99,
      shippingEstimate: 4.5,
      ...
      rawData: {
        productNameEn: 'STEM Robot Kit for Kids',
        categoryName: 'STEM Toys',
        weight: '0.6kg',
        score: 9.2,
        verdict: 'SELL',
      },
    },
    {
      ...
      description:
        'Auto-bubble gun producing 500+ bubbles per minute with colorful LED disco lights.',
      costPrice: 7.2,
      sellingPrice: 19.99,
      ...
      rawData: {
        productNameEn: 'Bubble Machine Gun',
        categoryName: 'Outdoor Play',
        weight: '0.35kg',
        score: 8.8,
        verdict: 'SELL',
    ...
    // ============================================================
    {
      ...
      description:
        'Ethically sourced Arabica beans from Colombian highlands. Rich chocolate and berry flavor profile.',
      costPrice: 9.0,
      sellingPrice: 24.99,
      shippingEstimate: 2.8,
      ...
      rawData: {
        productNameEn: 'Single Origin Dark Roast Coffee',
        categoryName: 'Coffee',
        weight: '0.55kg',
        score: 9.3,
        verdict: 'SELL',
    ...
    },
    {
      ...
      description:
        'Premium blend of cashews, almonds, macadamia, and Brazil nuts. Zero artificial preservatives.',
      costPrice: 11.0,
      sellingPrice: 29.99,
      shippingEstimate: 3.0,
      ...
      variants: [
        {
          externalId: 'CJ-VAR-GRC-102-A',
          sku: 'NUTS-102-1KG',
          title: '1kg Variety Pack',
          costPrice: 11.0,
          sellingPrice: 29.99,
          stock: 400,
        },
      ...
      rawData: {
        productNameEn: 'Gourmet Mixed Nuts 1kg',
        categoryName: 'Snacks',
        weight: '1.05kg',
        score: 8.9,
        verdict: 'SELL',
    ...
    // ============================================================
    {
      ...
      description:
        'High protein formula with real salmon as #1 ingredient. Omega 3 & 6 for a shiny coat.',
      costPrice: 18.0,
      sellingPrice: 49.99,
      shippingEstimate: 5.5,
      ...
      rawData: {
        productNameEn: 'Grain-Free Salmon Dog Food',
        categoryName: 'Pet Food',
        weight: '5.2kg',
        score: 9.1,
        verdict: 'SELL',
    ...
    },
    {
      ...
      description:
        'Collapsible carrier with mesh windows, fleece mat, shoulder strap, and safety leash hook.',
      costPrice: 16.5,
      sellingPrice: 44.99,
      shippingEstimate: 4.2,
      ...
      variants: [
        ...
        {
          externalId: 'CJ-VAR-PET-102-B',
          sku: 'CARRIER-102-MD',
          title: 'Medium (up to 9kg)',
          costPrice: 20.0,
          sellingPrice: 54.99,
          stock: 140,
        },
      ...
      rawData: {
        productNameEn: 'Airline Approved Pet Carrier',
        categoryName: 'Pet Accessories',
        weight: '0.9kg',
        score: 8.7,
        verdict: 'SELL',
    ...
    // ============================================================
    {
      ...
      description:
        'Fast-drying ionic technology reduces frizz and adds shine. Cool shot button and 3 heat settings.',
      costPrice: 19.5,
      sellingPrice: 55.99,
      shippingEstimate: 4.0,
    ...
    // ============================================================
    {
      ...
      description:
        'Eco-friendly TPE foam mat with alignment lines, carry strap, and sweat-resistant surface.',
      costPrice: 9.5,
      sellingPrice: 29.99,
      shippingEstimate: 3.8,
