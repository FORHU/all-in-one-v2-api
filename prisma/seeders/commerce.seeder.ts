...
const COMMERCE_BY_TENANT: Record<string, TenantCommerceSeed> = {
  [TENANT_IDS.FASHION]: {
    orders: [
      {
        ...
        items: [
          { variantSku: 'HD-001-BLK-XL', quantity: 1 },
          { variantSku: 'CAP-007-BLK', quantity: 1 },
        ],
      },
      {
        customerEmail: 'customer2@marketplace.com',
        status: OrderStatus.PROCESSING,
        items: [{ variantSku: 'SNK-005-BLK-42', quantity: 1 }],
      },
      {
        customerEmail: 'customer3@marketplace.com',
        status: OrderStatus.FULFILLED,
        items: [
          { variantSku: 'TEE-002-WHT-M', quantity: 2 },
          { variantSku: 'CGO-003-OLV-32', quantity: 1 },
        ],
      },
      {
        customerEmail: 'customer4@marketplace.com',
        status: OrderStatus.CANCELLED,
        items: [{ variantSku: 'BMB-004-SLV-L', quantity: 1 }],
      },
      {
        customerEmail: 'customer5@marketplace.com',
        status: OrderStatus.REFUNDED,
        items: [{ variantSku: 'DRS-006-FLR-M', quantity: 1 }],
      },
    ],
    reviews: [
      {
      ...
      },
      {
        ...
        customerEmail: 'customer2@marketplace.com',
        rating: 4,
        title: 'Great everyday hoodie',
        comment: 'Really warm and the oversized fit is perfect for layering.',
      },
      {
        productSlug: 'y2k-satin-bomber-jacket',
        customerEmail: 'customer3@marketplace.com',
        rating: 5,
        title: 'Turns heads every time',
        comment: 'The satin finish looks even better in person. True to size.',
      },
      {
        ...
        comment: 'Pretty print but I had to size down. Would still recommend.',
      },
      {
        productSlug: 'tactical-relaxed-cargo-pants',
        customerEmail: 'customer5@marketplace.com',
        rating: 2,
        title: 'Fabric feels thinner than expected',
        comment: 'Looks good but the ripstop fabric felt cheaper than the photos suggested.',
        merchantReply: 'Sorry to hear that — reaching out to make this right!',
      },
    ],
    coupons: [
      {
    ...
    wishlists: [
      ...
      {
        customerEmail: 'customer3@marketplace.com',
        variantSkus: ['BMB-004-BLK-M', 'DRS-006-PNK-M'],
      },
      { customerEmail: 'customer4@marketplace.com', variantSkus: ['TEE-002-BLK-M'] },
      {
        customerEmail: 'customer5@marketplace.com',
        variantSkus: ['CGO-003-BLK-30', 'SNK-005-RED-43'],
      },
    ],
  },
  [TENANT_IDS.BEAUTY]: {
    orders: [
      {
        ...
        status: OrderStatus.PENDING,
        items: [
          { variantSku: 'SRM-002-30ML', quantity: 1 },
          { variantSku: 'MST-003-50ML', quantity: 1 },
        ],
      },
      {
        customerEmail: 'customer2@marketplace.com',
        status: OrderStatus.PROCESSING,
        items: [{ variantSku: 'LIP-004-TERRA', quantity: 2 }],
      },
      {
        customerEmail: 'customer3@marketplace.com',
        status: OrderStatus.FULFILLED,
        items: [{ variantSku: 'EDP-006-50ML', quantity: 1 }],
      },
      {
        customerEmail: 'customer4@marketplace.com',
        status: OrderStatus.CANCELLED,
        items: [{ variantSku: 'HDRYR-005-ROSE', quantity: 1 }],
      },
      {
        customerEmail: 'customer5@marketplace.com',
        status: OrderStatus.REFUNDED,
        items: [
          { variantSku: 'BTR-007-200ML', quantity: 1 },
          { variantSku: 'FAC-001-PNK', quantity: 1 },
        ],
      },
    ],
    reviews: [
      {
        ...
        comment: 'My dark spots have noticeably faded. Absorbs quickly with no stickiness.',
        merchantReply: 'So glad it worked for you! Thank you for sharing.',
      },
      {
        productSlug: 'waterproof-sonic-facial-cleansing-brush',
        customerEmail: 'customer2@marketplace.com',
        rating: 5,
        title: 'Deep clean without irritation',
        comment: 'Gentle enough for daily use, my skin feels so much smoother.',
      },
      {
        productSlug: 'citrus-bloom-eau-de-parfum',
        customerEmail: 'customer3@marketplace.com',
        rating: 4,
        title: 'Fresh but doesn’t last all day',
        comment: 'Smells amazing on application but fades by late afternoon.',
      },
      {
        ...
        rating: 3,
        title: 'Good but loud',
        comment: 'Dries hair fast, but noise level is higher than my old dryer.',
      },
      {
        productSlug: 'matte-liquid-lipstick-trio',
        customerEmail: 'customer5@marketplace.com',
        rating: 2,
        title: 'Dries out my lips',
        comment: 'Color payoff is great but it feels drying after a few hours.',
        merchantReply:
          'Thanks for the honest review — we recommend pairing with a lip balm underneath!',
      },
    ],
    coupons: [
      {
    ...
    wishlists: [
      {
        customerEmail: 'customer@marketplace.com',
        variantSkus: ['EDP-006-100ML', 'BTR-007-400ML'],
      },
      ...
      {
        customerEmail: 'customer5@marketplace.com',
        variantSkus: ['HDRYR-005-BLK', 'SRM-002-50ML'],
      },
    ],
  },
  [TENANT_IDS.ELECTRONICS]: {
    orders: [
      {
        ...
        status: OrderStatus.PENDING,
        items: [
          { variantSku: 'GM-001-BLK', quantity: 1 },
          { variantSku: 'KB-003-RED', quantity: 1 },
        ],
      },
      {
        customerEmail: 'customer2@marketplace.com',
        status: OrderStatus.PROCESSING,
        items: [{ variantSku: 'ANC-002-BLK', quantity: 1 }],
      },
      {
        customerEmail: 'customer3@marketplace.com',
        status: OrderStatus.FULFILLED,
        items: [{ variantSku: 'WATCH-006-GRP-42', quantity: 1 }],
      },
      {
        customerEmail: 'customer4@marketplace.com',
        status: OrderStatus.CANCELLED,
        items: [{ variantSku: 'HUB-005-CHR', quantity: 1 }],
      },
      {
        customerEmail: 'customer5@marketplace.com',
        status: OrderStatus.REFUNDED,
        items: [
          { variantSku: 'SPK-007-BLU', quantity: 1 },
          { variantSku: 'CAM-004-BLK', quantity: 1 },
        ],
      },
    ],
    reviews: [
      {
        ...
        customerEmail: 'customer@marketplace.com',
        rating: 5,
        title: 'Incredible tracking precision',
        comment: 'Zero latency and the RGB looks amazing on stream.',
        merchantReply: 'Appreciate the review — happy gaming!',
      },
      {
        productSlug: 'active-noise-cancelling-wireless-headphones',
        customerEmail: 'customer2@marketplace.com',
        rating: 5,
        title: 'ANC is on another level',
        comment: 'Blocks out my entire open office. Battery lasts all week.',
      },
      {
        productSlug: 'fitness-smartwatch-amoled-display',
        customerEmail: 'customer3@marketplace.com',
        rating: 4,
        title: 'Great tracking, so-so app',
        comment: 'Heart rate data is accurate but the companion app could be more polished.',
      },
      {
        productSlug: 'compact-75-mechanical-rgb-keyboard',
        customerEmail: 'customer4@marketplace.com',
        rating: 3,
        title: 'Great feel, loud switches',
        comment: 'Typing feels premium but the brown switches are louder than expected.',
      },
      {
        productSlug: 'ultra-hd-4k-streaming-webcam-ring-light',
        customerEmail: 'customer5@marketplace.com',
        rating: 2,
        title: 'Autofocus struggles in low light',
        comment: 'Image quality is fine in daylight but hunts for focus at night.',
        merchantReply:
    ...
    wishlists: [
      {
        customerEmail: 'customer@marketplace.com',
        variantSkus: ['WATCH-006-SLV-46', 'ANC-002-SLV'],
      },
      ...
      {
        customerEmail: 'customer5@marketplace.com',
        variantSkus: ['SPK-007-RED', 'WATCH-006-RGD-42'],
      },
    ],
  },
  [TENANT_IDS.LIVING]: {
    orders: [
      {
        customerEmail: 'customer@marketplace.com',
        status: OrderStatus.PENDING,
        items: [{ variantSku: 'DIF-001-WOD', quantity: 1 }],
      },
      {
        customerEmail: 'customer2@marketplace.com',
        status: OrderStatus.PROCESSING,
        items: [
          { variantSku: 'LMP-002-WHT', quantity: 1 },
          { variantSku: 'SHF-007-3T-NAT', quantity: 1 },
        ],
      },
      {
        customerEmail: 'customer3@marketplace.com',
        status: OrderStatus.FULFILLED,
        items: [{ variantSku: 'CHR-003-CRM', quantity: 1 }],
      },
      {
        customerEmail: 'customer4@marketplace.com',
        status: OrderStatus.CANCELLED,
        items: [{ variantSku: 'RUG-004-5X7', quantity: 1 }],
      },
      {
        customerEmail: 'customer5@marketplace.com',
        status: OrderStatus.REFUNDED,
        items: [
          { variantSku: 'SHT-006-QN-IVR', quantity: 1 },
          { variantSku: 'DIN-005-WHT', quantity: 1 },
        ],
      },
    ],
    reviews: [
      {
        ...
        customerEmail: 'customer@marketplace.com',
        rating: 5,
        title: 'Statement piece for our living room',
        comment: 'Incredibly comfortable and the boucle fabric feels premium.',
        merchantReply: 'Thank you — so glad it fits your space perfectly!',
      },
      {
        productSlug: 'egyptian-cotton-bedsheet-set',
        customerEmail: 'customer2@marketplace.com',
        rating: 5,
        title: 'Softest sheets we have owned',
        comment: 'Hotel-quality feel and the color has held up after many washes.',
      },
      {
        productSlug: 'ultrasonic-cool-mist-aromatherapy-diffuser',
        customerEmail: 'customer3@marketplace.com',
        rating: 4,
        title: 'Quiet and stylish',
        comment:
          'Runs silently overnight, though the light ring is a bit bright on the highest setting.',
      },
      {
        productSlug: 'handwoven-jute-area-rug',
        customerEmail: 'customer4@marketplace.com',
        rating: 3,
        title: 'Nice texture, sheds a little',
        comment: 'Looks great but sheds fibers for the first couple of weeks.',
      },
      {
        productSlug: 'ceramic-dinnerware-set-12-piece',
        customerEmail: 'customer5@marketplace.com',
        rating: 2,
        title: 'One plate arrived chipped',
        comment: 'Otherwise beautiful glaze, but packaging needs improvement.',
        merchantReply: 'So sorry about that — our support team has reached out with a replacement.',
      },
    ],
    coupons: [
      {
    ...
    wishlists: [
      ...
      {
        customerEmail: 'customer3@marketplace.com',
        variantSkus: ['SHT-006-KG-SLT', 'DIN-005-TER'],
      },
      { customerEmail: 'customer4@marketplace.com', variantSkus: ['SHF-007-4T-WAL'] },
      {
        customerEmail: 'customer5@marketplace.com',
        variantSkus: ['DIF-001-WHT', 'SHT-006-QN-SLT'],
      },
    ],
  },
  [TENANT_IDS.OUTDOOR]: {
    orders: [
      {
        customerEmail: 'customer@marketplace.com',
        status: OrderStatus.PENDING,
        items: [{ variantSku: 'BOT-001-BLK', quantity: 2 }],
      },
      {
        customerEmail: 'customer2@marketplace.com',
        status: OrderStatus.PROCESSING,
        items: [{ variantSku: 'YOGA-002-PRP', quantity: 1 }],
      },
      {
        customerEmail: 'customer3@marketplace.com',
        status: OrderStatus.FULFILLED,
        items: [
          { variantSku: 'TNT-003-ORG', quantity: 1 },
          { variantSku: 'PCK-004-GRP', quantity: 1 },
        ],
      },
      {
        customerEmail: 'customer4@marketplace.com',
        status: OrderStatus.CANCELLED,
        items: [{ variantSku: 'POL-005-SLVBLU', quantity: 1 }],
      },
      {
        customerEmail: 'customer5@marketplace.com',
        status: OrderStatus.REFUNDED,
        items: [
          { variantSku: 'JER-006-BLU-M', quantity: 1 },
          { variantSku: 'SUP-007-TEAL', quantity: 1 },
        ],
      },
    ],
    reviews: [
      {
        ...
        customerEmail: 'customer@marketplace.com',
        rating: 5,
        title: 'Survived a 3-day storm',
        comment: 'Setup took under 5 minutes and it kept us completely dry.',
        merchantReply: 'Glad it held up out there — thanks for the review!',
      },
      {
        productSlug: 'double-wall-vacuum-insulated-bottle-32oz',
        customerEmail: 'customer2@marketplace.com',
        rating: 5,
        title: 'Ice cold for two full days',
        comment: 'No leaks even upside down in my pack. Highly recommend.',
      },
      {
        productSlug: 'inflatable-stand-up-paddleboard-10ft',
        customerEmail: 'customer3@marketplace.com',
        rating: 4,
        title: 'Stable and easy to inflate',
        comment: 'Great for beginners, though the included pump is slow.',
      },
      {
        productSlug: 'all-terrain-hiking-backpack-28l',
        customerEmail: 'customer4@marketplace.com',
        rating: 3,
        title: 'Comfortable but tight on space',
        comment: '28L fills up fast for overnight trips, otherwise great fit.',
      },
      {
        productSlug: 'anti-slip-professional-yoga-mat-6mm',
        customerEmail: 'customer5@marketplace.com',
        rating: 2,
        title: 'Slippery when sweaty',
        comment: 'Alignment lines are great but grip fades once I really start sweating.',
        merchantReply:
          'Thanks for the feedback — we recommend our microfiber towel topper for high-sweat sessions.',
      },
    ],
    coupons: [
      {
    ...
    wishlists: [
      ...
      {
        customerEmail: 'customer3@marketplace.com',
        variantSkus: ['SUP-007-CORAL', 'JER-006-BLK-L'],
      },
      { customerEmail: 'customer4@marketplace.com', variantSkus: ['BOT-001-GRN'] },
      {
        customerEmail: 'customer5@marketplace.com',
        variantSkus: ['YOGA-002-BLK', 'JER-006-BLU-L'],
      },
    ],
  },
};
...
export async function seedCommerce(prisma: PrismaClient) {
  ...
  for (const [tenantId, tenantData] of Object.entries(COMMERCE_BY_TENANT)) {
        ...
        for (const itemDef of orderDef.items) {
          ...
          if (!variant) {
            process.stderr.write(
              `⚠️ Variant [${itemDef.variantSku}] not found for tenant [${tenantId}]. Skipping item.\n`,
            );
            continue;
          }
          resolvedItems.push({
    ...
    const firstProductVariant = await prisma.catalogProductVariant.findFirst({
      where: { tenantId },
    });
