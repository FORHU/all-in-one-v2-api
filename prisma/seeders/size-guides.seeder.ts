...
const SIZE_GUIDES_BY_TENANT: Record<string, SizeGuideSeed[]> = {
  [TENANT_IDS.FASHION]: [
    {
      ...
      unit: 'CM',
      entries: [
        { sizeLabel: 'M', position: 1, variantSku: 'HD-001-NVY-M', chest: 108, waist: 92, sleeve: 62, shoulder: 48, length: 72 },
        { sizeLabel: 'L', position: 2, chest: 114, waist: 98, sleeve: 64, shoulder: 50, length: 74 },
        { sizeLabel: 'XL', position: 3, variantSku: 'HD-001-BLK-XL', chest: 120, waist: 104, sleeve: 66, shoulder: 52, length: 76 },
      ],
    },
    {
      ...
      unit: 'CM',
      entries: [
        { sizeLabel: 'S', position: 1, variantSku: 'TEE-002-WHT-S', chest: 102, length: 68, shoulder: 44 },
        { sizeLabel: 'M', position: 2, variantSku: 'TEE-002-WHT-M', chest: 108, length: 70, shoulder: 46 },
        { sizeLabel: 'M-Black', position: 3, variantSku: 'TEE-002-BLK-M', chest: 108, length: 70, shoulder: 46 },
      ],
    },
    {
      ...
      unit: 'CM',
      entries: [
        { sizeLabel: 'W30', position: 1, variantSku: 'CGO-003-BLK-30', waist: 76, hips: 102, inseam: 76 },
        { sizeLabel: 'W32', position: 2, variantSku: 'CGO-003-OLV-32', waist: 81, hips: 107, inseam: 78 },
    ...
    },
    {
      ...
      unit: 'CM',
      entries: [
        { sizeLabel: 'M', position: 1, variantSku: 'BMB-004-BLK-M', chest: 106, shoulder: 47, sleeve: 63, length: 66 },
        { sizeLabel: 'L', position: 2, variantSku: 'BMB-004-SLV-L', chest: 112, shoulder: 49, sleeve: 65, length: 68 },
      ],
    },
    {
      ...
      unit: 'CM',
      entries: [
        { sizeLabel: 'S', position: 1, variantSku: 'DRS-006-FLR-S', chest: 86, waist: 68, hips: 94, length: 108 },
        { sizeLabel: 'M', position: 2, variantSku: 'DRS-006-FLR-M', chest: 91, waist: 73, hips: 99, length: 110 },
        { sizeLabel: 'M-Pink', position: 3, variantSku: 'DRS-006-PNK-M', chest: 91, waist: 73, hips: 99, length: 110 },
      ],
    },
    {
  ...
  [TENANT_IDS.BEAUTY]: [
    {
      ...
      unit: 'ML',
      entries: [
        { sizeLabel: '30ml', position: 1, variantSku: 'SRM-002-30ML', weight: 30, weightUnit: 'ML' },
        { sizeLabel: '50ml', position: 2, variantSku: 'SRM-002-50ML', weight: 50, weightUnit: 'ML' },
      ],
    },
    {
      ...
      unit: 'ML',
      entries: [
        { sizeLabel: '50ml', position: 1, variantSku: 'MST-003-50ML', weight: 50, weightUnit: 'ML' },
        { sizeLabel: '100ml', position: 2, variantSku: 'MST-003-100ML', weight: 100, weightUnit: 'ML' },
      ],
    },
    {
      ...
      unit: 'ML',
      entries: [
        { sizeLabel: '30ml', position: 1, variantSku: 'EDP-006-30ML', weight: 30, weightUnit: 'ML' },
        { sizeLabel: '50ml', position: 2, variantSku: 'EDP-006-50ML', weight: 50, weightUnit: 'ML' },
        { sizeLabel: '100ml', position: 3, variantSku: 'EDP-006-100ML', weight: 100, weightUnit: 'ML' },
      ],
    },
    {
      ...
      unit: 'ML',
      entries: [
        { sizeLabel: '200ml', position: 1, variantSku: 'BTR-007-200ML', weight: 200, weightUnit: 'ML' },
        { sizeLabel: '400ml', position: 2, variantSku: 'BTR-007-400ML', weight: 400, weightUnit: 'ML' },
      ],
    },
    {
      ...
      unit: 'CM',
      entries: [{ sizeLabel: 'Standard', position: 1, height: 16.5, width: 4.2, weight: 0.12, weightUnit: 'KG' }],
    },
    {
      ...
      unit: 'CM',
      entries: [{ sizeLabel: 'Standard', position: 1, height: 24.0, width: 9.5, weight: 0.65, weightUnit: 'KG' }],
    },
  ],
  [TENANT_IDS.ELECTRONICS]: [
    {
      ...
      unit: 'CM',
      entries: [{ sizeLabel: 'Standard', position: 1, width: 9.4, height: 3.8, depth: 4.2, weight: 0.30, weightUnit: 'KG' }],
    },
    {
      ...
      unit: 'CM',
      entries: [{ sizeLabel: 'Standard', position: 1, width: 32.5, depth: 13.6, height: 3.6, weight: 0.75, weightUnit: 'KG' }],
    },
    {
      ...
      unit: 'CM',
      entries: [{ sizeLabel: 'Standard', position: 1, height: 18.6, width: 8.6, weight: 0.55, weightUnit: 'KG' }],
    },
    {
    ...
    },
    {
      ...
      unit: 'CM',
      entries: [{ sizeLabel: 'Standard', position: 1, width: 10.0, height: 10.0, depth: 3.5, weight: 0.40, weightUnit: 'KG' }],
    },
  ],
  [TENANT_IDS.LIVING]: [
    {
    ...
    },
    {
      ...
      entries: [
        ...
        { sizeLabel: 'Queen-Slate', position: 3, variantSku: 'SHT-006-QN-SLT', width: 152, length: 203 },
      ],
    },
    {
      ...
      unit: 'CM',
      entries: [
        { sizeLabel: '3-Tier', position: 1, variantSku: 'SHF-007-3T-NAT', width: 80, height: 90, depth: 30 },
        { sizeLabel: '4-Tier', position: 2, variantSku: 'SHF-007-4T-WAL', width: 80, height: 120, depth: 30 },
      ],
    },
    {
      ...
      unit: 'CM',
      entries: [{ sizeLabel: 'Standard', position: 1, width: 76, height: 79, depth: 71, weight: 14.5, weightUnit: 'KG' }],
    },
    {
  ...
  [TENANT_IDS.OUTDOOR]: [
    ...
    },
    {
      ...
      unit: 'CM',
      entries: [{ sizeLabel: '2-Person', position: 1, length: 213, width: 127, weight: 2.1, weightUnit: 'KG' }],
    },
    {
    ...
    },
    {
      ...
      unit: 'CM',
      entries: [
        { sizeLabel: 'M', position: 1, variantSku: 'JER-006-BLU-M', chest: 96, waist: 82, length: 68 },
        { sizeLabel: 'L', position: 2, variantSku: 'JER-006-BLU-L', chest: 102, waist: 88, length: 70 },
        { sizeLabel: 'L-Black', position: 3, variantSku: 'JER-006-BLK-L', chest: 102, waist: 88, length: 70 },
      ],
    },
    {
      ...
      unit: 'FT',
      entries: [{ sizeLabel: '10ft', position: 1, length: 10, width: 2.6, weight: 9.8, weightUnit: 'KG' }],
    },
  ],
};
